...
This RMarkdown Notebook will walk you through the steps of calculating the Theil Index, a measure of economic inequality. The formula for calculating the Theil Index with two variables is as follows:
...
The Theil Index can also be calculated using more than two subgroups. 
